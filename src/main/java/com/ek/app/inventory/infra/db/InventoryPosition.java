...
@Builder
@Entity
@Table(name = "inventory_position", indexes = {
		@Index(name = "idx_inventory_position_product", columnList = "product_id"),
		@Index(name = "idx_inventory_position_on_hand", columnList = "on_hand_qty")
})
