...
public class SecurityConfig {
    ...
    @Bean
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/stock-in/**", "/api/daily-operations/**", "/api/end-of-day-operations/**").hasAnyRole("ADMIN", "OPERATION_MANAGER")
                .requestMatchers("/api/inventory/**").hasAnyRole("ADMIN", "OPERATION_MANAGER")
                .requestMatchers("/api/stock-movements/**").hasAnyRole("ADMIN", "OPERATION_MANAGER")
